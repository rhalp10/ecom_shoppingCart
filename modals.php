  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <form enctype="multipart/form-data" method="post" action="action?id=<?php echo $id ?>">
            ...
            <table class="form">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input class="large-field" type="text" value="<?php echo $cus_Name;?>" name="fullname"   required=""  id="e_fullname"></td>
                </tr>
                <tr>
                  <td><span class="required">*</span> E-Mail:</td>
                  <td><input class="large-field" type="text" value="<?php echo $cus_Email;?>" name="email" required=""  id="e_email"></td>
                </tr>
                <tr>
                  <td><span class="required">*</span> Phone:</td>
                  <td><input class="large-field" type="number" value="<?php echo $cus_Phone;?>" name="phone" required=""  id="e_phone"></td>
                </tr>
                <tr>
                  <td><span class="required">*</span> Address:</td>
                  <td><input class="large-field" type="text" value="<?php echo $cus_Address;?>" name="address" required=""  id="e_address"></td>
                </tr>
              </tbody>
            </table>
          </div>
