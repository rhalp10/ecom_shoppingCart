  ...
  <div class="main-wide">
    ...
    <div id="container">
      ...
      <div id="content">
        ...
        <div class="breadcrumb"> <a href="index">Home</a> » <a href="">Shopping Cart</a></div>
        <!--Breadcrumb Part End-->
        ...
        <form enctype="multipart/form-data" method="post" action="">
          <div class="cart-info">
            <table>
              ...
              <tbody>
                <tr>
                  <td class="image"><a href="product"><img src="image/product/ipod_classic_1-45x45.jpg" alt="iPad Classic" /></a></td>
                  <td class="name"><a href="product">iPad Classic</a></td>
                  ...
                  <td class="price">$112.00</td>
                  <td class="total">$112.00</td>
                </tr>
                <tr>
                  <td class="image"><a href="product"><img src="image/product/lotto-sports-shoes-white-45x45.jpg" alt="Lotto Sports Shoes" /></a></td>
                  <td class="name"><a href="product">Lotto Sports Shoes</a><br>
                ...
                <tr>
                  <td class="image"><a href="product"><img src="image/product/Jeep-Casual-Shoes-45x45.jpg" alt="Jeep-Casual-Shoes" /></a></td>
                  <td class="name"><a href="product">Jeep-Casual-Shoes</a></td>
                  <td class="model">Product 3</td>
                  <td class="quantity"><input type="text" size="1" value="1" name="" class="w30">
                    &nbsp;
                    <input type="image" title="Update" alt="Update" src="image/update.png">
                    &nbsp;<a href="#"><img title="Remove" alt="Remove" src="image/remove.png"></a></td>
                  <td class="price">$240.50</td>
                  <td class="total">$240.50</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <div class="accordion-content">
              <div style="display: block;" class="content" id="shipping">
                ...
                <table cellspacing="10">
                  ...
                  <td>&nbsp;</td>
                    <td><input type="button" class="button" id="button-quote" value="Get Quotes"></td>
                    </tbody>
                </table>
              </div>
            </div>
          ...
          <table id="total">
            <tbody>
              <tr>
                ...
                <td class="right">$710.50</td>
              </tr>
              <tr>
                <td class="right"><b>Total:</b></td>
                <td class="right">$810.00</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div class="buttons">
          <div class="right"><a class="button" href="checkout">Checkout</a></div>
