...
<html>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <button  type="button" class="btn btn-primary" data-toggle="modal" data-target="#view" id="categories_view" data-id="<?php echo $row['cat_ID']?>"><span class="   glyphicon glyphicon-eye-open"></span></button>
                                    <button type="button" class="btn btn-info"  data-toggle="modal" data-target="#edit" id="categories_edit" data-id="<?php echo $row['cat_ID']?>"><span class="glyphicon glyphicon-edit"></span></button>
                                    <button type="button" class="btn btn-danger"  data-toggle="modal" data-target="#delete" id="categories_delete" data-id="<?php echo $row['cat_ID']?>"><span class="glyphicon glyphicon-remove" ></span></button>
                                </div>
                            </td>
                        </tr>
                        <?php
   ...
   <script type="text/javascript">
           ...
           $(document).on('click', '#categories_view', function(e){
           ...
           $(document).on('click', '#categories_edit', function(e){
           ...
           $(document).on('click', '#categories_delete', function(e){
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <button type="submit" class="btn btn-default" name="categories_add">Submit</button>
      </form>
      </div>
